...
sampled data.
        ...
        percentile = ( data, observation ) ->
            ...
            numberBelowObservation / data.length
        standards = [
        ...
        thisTime = [
            matchData.goldinearlygame
            matchData.goldinmidgame
            matchData.goldinlategame
        ]
        percentiles =
            ( percentile standards[i], thisTime[i] for i in [0..2] )
