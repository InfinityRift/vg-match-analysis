...
# Harvester for percent of time holding flares

Compute the percentage of the match during which the player was holding a
flare, flare gun, or contraption.  No notion of cooldown is taken into
account here.  Just your possession of the item is what's tracked, as a
proxy for your readiness to launch a flare.
...
Track these items:
        ...
        trackedItems = [ 'Flare', 'Flaregun', 'Contraption' ]
