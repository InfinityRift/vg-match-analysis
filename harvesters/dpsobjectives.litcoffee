...
# Harvester for highest DPS done to objectives

Highest damage per second done to any objective in the match.  Track this by
role and skill tier, using the appropriate formuals in [the utilities module
in this folder](utils.litcoffee).  We build this module using the basic
...
damage to an objective "continuously," meaning no break of >2sec between
